...
No meu GitHub, compartilho projetos como aplicações front-end e projetos em Python, buscando evoluir minhas habilidades técnicas, organização de código e boas práticas de desenvolvimento.
...
- **RecipeApp** — aplicação desenvolvida em Python.
- **Projetos acadêmicos** — estudos e práticas envolvendo Engenharia de Software, POO, UML e desenvolvimento web.
